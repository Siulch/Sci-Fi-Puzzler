...
public class GameLogic : MonoBehaviour
{
    ...
    public GameObject startPoint, point, pointTwo, pointThree, playPoint, restartPoint;
    ...
    void Update()
    {
        ...
        else if (player.transform.position == pointTwo.transform.position)
        {
            //RotatePlayer();
            iTween.MoveTo(player,
                iTween.Hash(
        ...
        else if (player.transform.position == pointThree.transform.position)
        {
            //RotatePlayer();
            iTween.MoveTo(player,
                iTween.Hash(
            ...
            InvokeRepeating("DisplayPattern", 5, puzzleSpeed);
    ...
    void RotatePlayer()
    {
        iTween.RotateTo(player, iTween.Hash(
          "y", player.gameObject.transform.eulerAngles.y + 90,
          "time", 3,
